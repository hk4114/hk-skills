...
- [Advanced Reference: Component Patterns \& Code Templates](#advanced-reference-component-patterns--code-templates)
  - [Table of Contents](#table-of-contents)
  - [Responsive Slide Engine](#responsive-slide-engine)
  - [Device Simulation Frames](#device-simulation-frames)
    - [iPhone Frame](#iphone-frame)
    - [Browser Window Frame](#browser-window-frame)
  - [Tweaks Panel Implementation](#tweaks-panel-implementation)
  - [Animation Timeline Engine](#animation-timeline-engine)
  - [Design Canvas](#design-canvas)
  - [Dark Mode Toggle](#dark-mode-toggle)
  - [Data Visualization Templates](#data-visualization-templates)
    - [Chart.js Quick Start](#chartjs-quick-start)
  - [Color System Best Practices](#color-system-best-practices)
  - [Font Recommendations (Non-default Choices)](#font-recommendations-non-default-choices)
  - [Color × Font Pairing Reference](#color--font-pairing-reference)
